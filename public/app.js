...
async function saveConversation(silent) {
  ...
  try {
    await api("/conversations/" + S.convId, "PUT", {
      ...
      data: {
        content: S.content, role: S.role, scenario: S.scenario,
...
function goNewSession() {
  ...
  S.scenario = ""; S.docName = ""; S.docKind = ""; S.docSlides = 0;
...
var SCENARIOS = [
  ...
  { t: "Sceptical client", v: "Play a sceptical client evaluating this. Ask what it costs, what could go wrong, why you over a competitor, and press me when an answer sounds rehearsed." },
...
function setupHtml() {
  ...
  return '<div class="eyebrow" style="margin-bottom:10px">1 · CHOOSE YOUR MODE</div>' +
    ...
    'oninput="S.content=this.value;S.docName=&quot;&quot;"></textarea>' +
