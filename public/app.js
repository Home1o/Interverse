...
"- tip: EMPTY STRING almost always. Only fill it (max 20 words) if the candidate clearly dodged the question.";
...
function turnReminder() {
  ...
  var modeBit = S.mode === "interview"
    ? "Probe my last answer or move to the next item FROM MY MATERIAL. tip stays empty unless I dodged."
    : S.mode === "confidence"
